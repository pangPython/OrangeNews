...
<body>
		...
		<div class="container">
			...
			<div class="pages">
				<ul>
					...
					<li><a class="active" href="3dprinting.jsp">3D Printers</a></li>
	...
	<div class="container">
		<div class="header-bottom">
			...
			<div class="list-nav">
				<ul>                                                                 
					<li><a href="3dprinting.hjsp">3D Printing</a></li>|
					<li><a class="active" href="materials.jsp">Materials</a></li>|
		...
		<div class="content">
			<div class="col-md-7 printing-content">
				<div class="print-main">
					...
					<a href="single.jsp">3D Printed Dress at Paris Fashion week</a>
					<p class="sub_head">Posted by <a href="#">Admin</a> on june 14,2015</p>
					<a href="single.jsp"><img src="images/ep3.jpg" class="img-responsive" alt="" /></a>
				...
				<div class="print-grids">
					...
					<div class="print-grid">
						...
						<div class="print-text">
							<a class="bhead" href="single.jsp">Is 3D printing a threat to governments and our safety?</a>
							<p><a href="#">3D Printing, <a href="#">3D Software,</a><a href="#"> Files to Print </a> |   may 19, 2014</p>
							<p>This week Nokia announced it is giving away files for printable case for it’s new Lumia 820 range. This is</p>
							<a class="more" href="single.jsp">...Read More</a>
						</div>
