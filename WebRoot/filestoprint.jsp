		...
		<div class="header-bottom">
			...
			<div class="list-nav">
				<ul>                                                                 
					...
					<li><a class="active" href="filestoprint.jsp">Files to Print</a></li>|
		...
		<div class="content">
			<div class="col-md-7 printing-content">
				<div class="print-main">
					...
					<a href="single.jsp">Nokia offering customers printable STL phone cases for the Lumia 820</a>
				...
				<div class="print-grids">
					...
					<div class="print-grid">
						<div class="print-img">
							<a href="single.jsp"><img src="images/p5.jpg" class="img-responsive" alt="" /></a>
						</div>
						<div class="print-text">
							<a class="bhead" href="single.jsp">3D Things to Print #2 – Camera Lens Hood</a>
							<p><a href="#">3D Printing, <a href="#">3D Software,</a><a href="#"> Files to Print </a> |   may 19, 2014</p>
							<p>This week Nokia announced it is giving away files for printable case for it’s new Lumia 820 range. This is</p>
							<a class="more" href="single.jsp">...Read More</a>
						</div>
